...
namespace AVGK
{
    class AutoPDF
    {
       ...
       public string FFFT;
        ...
        public void LoadPDF(int IDTS, string NUs)//// загрузка формы уже с пользователем и проездом
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    data1.a[150] = reader["ChangeType"].ToString();                                                       //  alphaBlendTextBox68.Text = reader["ogranich"].ToString();//особ. условия. дороги
            ...
            if (ColPicKR < 16)
            {
                for (int i = 0; i < ColPicKR; i++)
                {
                    ...
                    connectionStringLB = conStrLB.StP;//"Data source=localhost;UserId=root;Password=1q2w3e$R;database=camloc;";
                    MySqlConnection connectionLB = new MySqlConnection(connectionStringLB);
                    if (Convert.ToDateTime(data1.a[8]) < Convert.ToDateTime("29.04.2018 11:42:00"))
                    {
                        zaprosLB.ZaprBitmap(NPicKR, PLN, IDpish);
                        zLB = zaprosLB.commandStringTest;
                        commandLB.CommandText = zLB;// commandString;
                        commandLB.Connection = connectionLB;
                    ...
                    {
                        zaprosLB.ZaprBitmapPHOTO(NPicKR, PLN, Convert.ToInt64(data1.a[4]));
                        zLB = zaprosLB.commandStringTest;
                        commandLB.CommandText = zLB;// commandString;
                        commandLB.Connection = connectionLB;
               ...
               // data1.c = new string[13, 7];
                ...
                ZGabarPDK();
                if (data1.a[3] != "" && Im != null && data1.a[150]!="4")//&& ImPl,ImAlt )
                {
                    soap2();
                    ZKL();
                    PDKOs();
        ...
        new XElement("EquipmentID", CPC.ToString()), //data1.a[14].ToString()),
        ...
        new XElement("ActID", Convert.ToString(CPC.ToString() + " - " + data1.a[4].ToString())),
        ...
        new XElement("ActPdf", Convert.ToString(data1.a[14] + "-" + data1.a[4] + "_" + DateTime.Now.ToString("ddMMyyyy") + ".pdf"))));
                    ...
                    //doc.Save(@"C:\\Users\\cherednikov\\Desktop\\АКТЫ\\" + NRUB + "_" + data1.a[4] + "_" + DateTime.Now.ToString("ddMMyyyy") + ".xml");
                    PDF();
                    //string aaa = @"C:\\Users\\cherednikov\\Desktop\\АКТЫ\\" + DateTime.Now.ToString("dd_MM_yyyy") + "\\";
                    ...
                    conStr.ConStr(1);
                    cstr = conStr.StP;
                    zapros.ZaprObrOTPRLoc(Convert.ToInt32(data1.a[4]), NamU, 4);
        ...
        static void CopyFolderYesterdayFiles(string sourceFolder, string destFolder)
        {
            ...
            //DirectoryInfo directory = new DirectoryInfo(@"C:\\Users\\cherednikov\\Desktop\\АКТЫ\\" + YesterdayDate.ToString("ddMMyyyy"));
            ...
            //DirectoryInfo directoryP = new DirectoryInfo(@"C:\\Users\\cherednikov\\Desktop\\АКТЫ\\" + YesterdayDate.ToString("ddMMyyyy"));
            ...
            //DirectoryInfo directoryI = new DirectoryInfo(@"C:\\Users\\cherednikov\\Desktop\\АКТЫ\\" + YesterdayDate.ToString("ddMMyyyy"));
        ...
        public void PDF()
        {
            ...
            A1[3] = data1.a[4];
            A1[4] = data1.a[9]; A1[5] = data1.a[11]; /*"Комплекс измерительный автоматического весового и габаритного контроля";*/ A1[6] = data1.a[12]; A1[7] = data1.a[13]; /*"001/02/2018 ";*/ A1[8] = CPC.ToString();
            ...
            A1[39] = data1.a[40]; A1[40] = data1.a[38]; A1[41] = TypNarTXT.ToString();/* A1[41] = data1.a[51];*/ /*A1[42] = data1.a[53];*/ A1[42] = MAXPREVPROTC.ToString();/*alphaBlendTextBox24.Text;*/
            A1[43] = MAXPREV.ToString();
            ...
            A1[218] = data1.a[200]; A1[229] = data1.a[201];
                ...
                if (ic < 8)
                {
                    if (PDKO[ic + 1] != 0)
                    {
                        ...
                        if (Math.Round(Convert.ToDouble(data1.b[8, ic]) / (PDKO[ic + 1] / 100) - 100, 2) > 0)
                        {
                            ...
                            if (Math.Floor(Math.Round(Convert.ToDouble(data1.b[8, ic]) / (PDKO[ic + 1] / 100) - 100, 2)) >= 3)
                            {
                                XDate[31] = "True";
                    ...
                    if (KNR[1, 0] == 1)
                    {
                        ...
                        if (Math.Round(Convert.ToDouble(data1.c[8, 0]) / (Convert.ToDouble(data1.c[9, 0]) / 100) - 100, 2) > 0)
                        {
                            ...
                            if (Math.Floor(Math.Round(Convert.ToDouble(data1.c[8, 0]) / (Convert.ToDouble(data1.c[9, 0]) / 100) - 100, 2)) >= 3)
                            {
                                XDate[31] = "True";
                    ...
                    for (ic = 1; ic < GrO; ic++)
                    {
                        if (KNR[1, ic] == 1)
                        {
                            ...
                            if (Math.Round(Convert.ToDouble(data1.c[8, ic]) / (Convert.ToDouble(data1.c[9, ic]) / 100) - 100, 2) > 0)
                            {
                                ...
                                if (Math.Floor(Math.Round(Convert.ToDouble(data1.c[8, ic]) / (Convert.ToDouble(data1.c[9, ic]) / 100) - 100, 2)) >= 3)
                                {
                                    XDate[31] = "True";
        ...
        public void ZKL()
        {
            ...
            try
            {
                ...
                while (reader2.Read())
                {
                    ...
                    if (data1.a[47] == "*Автопоезд*" || data1.a[47] == "*с прицепом*")
            ...
            try
            {
                ...
                while (reader2.Read())
                {
                    ...
                    {                        
                        ...
                        data1.a[53] = Convert.ToString(Math.Floor(Math.Round(Convert.ToDouble(data1.a[49])/ (Convert.ToDouble(data1.a[50])/ 100)-100,2)));
        ...
        private void soap2()
        {
            ...
            a.Dc = Dc; a.TWc = TW; a.GRZc = GRZ; a.Hc = H; a.Lc = L; a.Wc = W;
            a.IdPr = IDTSIsh;
            a.button1_Click();
            a.button2_Click();
        }
