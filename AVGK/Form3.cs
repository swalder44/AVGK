...
namespace AVGK
{
    public partial class Form3 : Form
    {
        ...
        public decimal Hpr;
        public decimal Wpr;
        public string[] Puti = new string[20];
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (NumberIter == 4)
                    {
                        ...
                        BetOs[10, 4] = Convert.ToDouble(reader["SpeedAxel"].ToString());
                    ...
                    if (NumberIter == 5)
                    {
                        ...
                        BetOs[10, 5] = Convert.ToDouble(reader["SpeedAxel"].ToString());
                    ...
                    if (reader["Plate"].ToString() == "")
                    {
                        ...
                        alphaBlendTextBox1.Text = reader["PlateRear"].ToString();
                    }
                    else
                    {
                    ...
                    if (Convert.ToBoolean(reader["CredenceExceeded"].ToString()) == false)
                    { label7.Text = "Ошибок не обнаружено"; }
                    else if (Convert.ToBoolean(reader["CredenceExceeded"].ToString()) == true)
                    { label7.Text = "Ошибка измерений"; }
                                ...
                                try
                                {
                                    ...
                                    while (readerLB.Read())
                                    {
                                        if (readerLB["name"].ToString() != "Video")
                                        {
                                            ...
                                            if (readerLB["name"].ToString() == "Image")
                                            {
                                                string st9 = @"'" + Puti[2] + "'" + readerLB["dataavailable"].ToString().Substring(13, readerLB["dataavailable"].ToString().Length - 13);
                                                //string st9 = readerLB["dataavailable"].ToString();
                                                pictureBox40.Image = new Bitmap(@"" + st9);
                                                Im = new Bitmap(@"" + st9);
                                            }
        ...
        public void ZagrdataGridView11(int IDp)
        {
            ...
            try
            {
                ...
                while (readerR.Read())
                {
                    ...
                    if (readerR["Plate"].ToString() == "")
                    { label30.Text = readerR["PlateRear"].ToString(); }
                    else
                    {
                    ...
                    if (readerR["Plate"].ToString() == "")
                    { maskedTextBox2.Text = readerR["PlateRear"].ToString(); }
                    else
                    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            new XElement("ActPdf", Convert.ToString(alphaBlendTextBox58.Text + "-" + alphaBlendTextBox25.Text + "_" + DateTime.Now.ToString("ddMMyyyy") + ".pdf"))));
                    ...
                    doc.Save(@"'" + Puti[3] + "'" + NRUB + "_" + alphaBlendTextBox25.Text + "_" + DateTime.Now.ToString("ddMMyyyy") + ".xml");
                    ...
                    CopyFolderYesterdayFiles(@"'" + Puti[3] + "'", aaa);
        ...
        {
            if (System.IO.File.Exists(@"F:\\archivACT\\act\\" + NRUB + "_" + alphaBlendTextBox25.Text + "_" + DateTime.Now.ToString("ddMMyyyy") + ".pdf"))
            {
                Process.Start(@"F:\\archivACT\\act\\" + NRUB + "_" + alphaBlendTextBox25.Text + "_" + DateTime.Now.ToString("ddMMyyyy") + ".pdf");
            }
            else
            {
                PDF();
                Process.Start(@"F:\\archivACT\\act\\" + NRUB + "_" + alphaBlendTextBox25.Text + "_" + DateTime.Now.ToString("ddMMyyyy") + ".pdf");
                //File.Delete(@"F:\\archiv\\AKT\\" + A1[259] + "_" + DateTime.Now.ToString("ddMMyyyy") + ".pdf");
                //File.Delete(@"F:\\archiv\\AKT\\" + A1[259] + "_" + DateTime.Now.ToString("ddMMyyyy") + "_1.jpeg");
                //File.Delete(@"F:\\archiv\\AKT\\" + A1[259] + "_" + DateTime.Now.ToString("ddMMyyyy") + "_2.jpeg");
                //File.Delete(@"F:\\archiv\\AKT\\" + A1[259] + "_" + DateTime.Now.ToString("ddMMyyyy") + "_3.jpeg");
            }
         }
            public void PDF()
        {
